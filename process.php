...
<div class="cv-container fade-in">
    ...
    <!-- SIDEBAR -->
    <div class="sidebar">
        <img src="<?php echo htmlspecialchars($targetFile); ?>" class="profile">
        ...
        <div class="edu-item">
            <span class="school"><?php echo htmlspecialchars($elementary); ?></span>
            <span class="year"><?php echo htmlspecialchars($elementary_year); ?></span>
        </div>

        <p class="education-label">Secondary Education</p>
        <div class="edu-item">
            <span class="school"><?php echo htmlspecialchars($secondary); ?></span>
            <span class="year"><?php echo htmlspecialchars($secondary_year); ?></span>
        </div>

        <p class="education-label">Tertiary Education</p>
        <div class="edu-item">
            <span class="school"><?php echo htmlspecialchars($tertiary); ?></span>
            <span class="year"><?php echo htmlspecialchars($tertiary_year); ?></span>
        </div>
    ...
    <div class="main">
        <div class="name-position">
            ...
            <div class="position"><?php echo htmlspecialchars($position); ?></div>
        </div>
        ...
        if (!empty($_POST['company'])) {
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                if (!empty($company)) {
                    ...
                    if ($i < $count - 1) echo '<hr class="minimal-hr">';
                }
            }
        }
        ?>
